...
class EmailServiceImplTests {
    ...
    void setUp() {
        ...
        assertNotEquals(0, alertSettingsRepository.count());
        assertNotEquals(0, suggestedPriceRepository.count());
    ...
    void tearDown() {
        ...
        suggestedPriceRepository.deleteAll();
        ...
        assertEquals(0, priceScrapingConfigRepository.count());
        assertEquals(0, alertRuleRepository.count());
        assertEquals(0, trackedProductRepository.count());
        assertEquals(0, userRepository.count());
        assertEquals(0, alertSettingsRepository.count());
        assertEquals(0, suggestedPriceRepository.count());
        assertEquals(0, retailerCompanyRepository.count());
        assertEquals(0, clientCompanyRepository.count());
    ...
    void sendOutEmailsSuccessfully() {
        ...
        emailService.sendEmailsAfterPriceScraping(this.startTime);
