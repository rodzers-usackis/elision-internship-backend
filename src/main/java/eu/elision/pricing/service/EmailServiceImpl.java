...
public class EmailServiceImpl implements EmailService {
    ...
    public String sendOutEmails(ProductsPricesScrapedEvent productsPricesScrapedEvent) {
        ...
        for (Map.Entry<User, List<Product>> entry : subscribedProductsMap.entrySet()) {
            ...
            bodyBuilder.append(
                    "<br>Please ensure that you stay informed about its prices and any related notifications.<br>If there are any significant changes, we will notify you promptly.<br><br>")
