...
import eu.elision.pricing.exceptions.RegistrationExceptionHandler;
...
public class AuthenticationController {
     ...
     *     with the JWT token
     */
    @CrossOrigin(origins = {"https://next-js-frontend-dot-pricing-as-a-service.ew.r.appspot.com", "http://81.240.96.43:3000", "http://81.240.96.43", "http://localhost:3000"})    @PostMapping("/login")
     ...
     */
    @CrossOrigin(origins = {"https://next-js-frontend-dot-pricing-as-a-service.ew.r.appspot.com", "http://81.240.96.43:3000", "http://81.240.96.43", "http://localhost:3000"})    @PostMapping("/register")
